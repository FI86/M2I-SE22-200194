...
# String multiligne
chaine = "une chaine de caractères très \
très longue"
...
# print("int a = " + a) # erreur de conatenation car a n'est pas str
print("int a = " + str(a))
...
# Mettre texte en majuscule la première lettre de la phrase
print(texte.capitalize())

# Mettre texte en majuscule à chaque début de mot
print(texte.title())